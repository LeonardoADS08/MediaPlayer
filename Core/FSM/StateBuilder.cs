...
{
    /// <summary>
    /// Builder providing a fluent API for constructing states. <para></para>
    ...
    public interface IStateBuilder<T, TParent> where T : AbstractState, new()
    {
        ...
        /// </summary>
        IStateBuilder<T, TParent> Update(Action<T, double> onUpdate);
        ...
        where T : AbstractState, new()
    {
        ...
        /// Set an action to be called when we update the state.
        /// </summary>
        public IStateBuilder<T, TParent> Update(Action<T, double> onUpdate)
        {
